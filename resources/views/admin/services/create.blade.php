                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <select name="hours" class="form-select @error('hours') is-invalid @enderror">
                                    @for ($i = 0; $i <= 11; $i++)
                                        <option value="{{ $i }}" {{ old('hours') == $i ? 'selected' : '' }}>{{ $i }} hr</option>
                                    @endfor
                                </select>
                                <input type="number" name="minutes" class="form-control @error('minutes') is-invalid @enderror"
                                    placeholder="Minutes" min="0" max="59" value="{{ old('minutes') }}">
                            </div>
                            ...
                            <small class="text-muted">You can choose hours, minutes, or both.</small>
                        </div>
