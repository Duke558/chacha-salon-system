...
<head>
    ...
    <title>ChaCha Salon - Beauty Salon</title>
    ...
    <style>
        /* Signature style for ChaCha only */
        .brand-signature {
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <div class="footer-info">
                        <h5>
                            <span class="brand-signature">ChaCha</span> Salon
                        </h5>
                        <p class="mt-3">
                            Your premier beauty destination in Ormoc City,
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <div class="footer-services">
                        <h5>Our Services</h5>
                        <ul class="list-unstyled mt-3">
                            <li><a href="#PACKAGE SERVICES">PACKAGE SERVICES</a></li>
                            <li><a href="#HAIR COLOURING">HAIR COLOURING</a></li>
                            <li><a href="#HAIR STYLING">HAIR STYLING</a></li>
                            <li><a href="#MAKEUP SERVICES">MAKEUP SERVICES</a></li>
                            <li><a href="#HAIR REBONDING AND PERM">HAIR REBONDING AND PERM</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer-contact">
                        ...
                        <ul class="list-unstyled contact-info mt-3">
                            <li>
                                ...
                                <span>Bonifacio Street, District 7 ( Pob) 6541 Ormoc City, Philippines</span>
                            </li>
                            <li>
                                <i class="fas fa-phone"></i>
                                <span>09950285920 <br> 09451040234 </span>
                            </li>
                            <li>
                                <i class="fas fa-envelope"></i>
                                <span>charlynebaledio79@gmail.com</span>
                            </li>
                        </ul>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="footer-bottom text-center">
                        ...
                        <p class="mb-0">
                            &copy; 2025 ChaCha Salon. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
