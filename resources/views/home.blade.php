        ...
        <div class="container h-100">
            <div
                ...
                <div class="text-center text-white col-lg-10 hero-content">
                    <h1 class="mb-3 hero-signature">Step Into Elegance at ChaCha Salon</h1>
                    <h2 class="mb-4 hero-subtitle hero-glow-border">Where Beauty Meets Luxury</h2>
                    <p class="mb-4 lead">
                        Indulge in an unparalleled salon experience tailored just for you. Our team of expert stylists and beauty professionals is dedicated to 
                        enhancing your natural charm with precision, care, and sophistication. Discover the art of luxury beauty at ChaCha Salon.
                    </p>
                ...
                <ul
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            type="button"
                            role="tab">
                            <i class="fa-solid fa-hand"></i>Nail care
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            <div class="gallery-item">
                                ...
                                <div class="gallery-overlay">
                                    <div class="overlay-content">
                                        <h4>Gel Nail Extension</h4>
                                        <p>Longer, stronger, and stunning.</p>
                                        <a
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="gallery-item">
                                ...
                                <div class="gallery-overlay">
                                    <div class="overlay-content">
                                        <h4>High-Gloss Gel Manicure</h4>
                                        <p>Vibrant, Mirror-Like Shine Guaranteed</p>
                                        <a
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="gallery-item">
                                ...
                                <div class="gallery-overlay">
                                    <div class="overlay-content">
                                        <h4>The Signature Essentials</h4>
                                        <p>Classic shaping, cuticle care, and perfect polish application.</p>
                                        <a
    ...
    <section id="about" class="py-5 text-white bg-dark">
        <div class="container">
            ...
            <div class="mb-5 section-title">
                ...
                <h2>Welcome to ChaCha Salon</h2>
                <p class="text-light-50">
                    Your Premier Beauty Destination Ormoc City
                </p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <h4>Visit Us</h4>
                        <p>ChaCha Salon<br />Ormoc City</p>
                        <a
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <h4>Call Us</h4>
                        <p>09950285920<br>09451040234</p>
                        <div class="business-hours">
                            <p class="mb-1">Mon - Sun: 9:00 AM - 8:00 PM</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <h4>Email Us</h4>
                        <p>charlynebaledio79@gmail.com</p>
